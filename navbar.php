                ...
                <ul class="list-unstyled components">
                    ...
                    <li class="">
                        ...
                        <ul class="collapse list-unstyled" id="machinemenu">
                            ...
                            <li><a href="addjobroles.php">Add Job Roles</a></li>
                            <li><a href="viewjobroles.php">View Job Roles</a></li>
                            <li><a href="deletejobroles.php">Delete Job Roles</a></li>
                            <li><a href="updatejobroles.php">Update Job Roles</a></li>
                        </ul>
                    </li>
